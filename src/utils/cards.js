    ...
    cards: [
        ...
        attacks: [
          {
            ...
            name: "Leek Slap",
            text:
              "Flip a coin. If tails, this attack does nothing. Either way, use this attack again as long as Farfetch'd stays in play (even putting Farfech'd on the Bench won't let you use it again.)",
            damage: "30",
            convertedEnergyCost: 1
          },
          {
        ...
        attacks: [
          {
            ...
            name: "Water Gun",
            text:
              "Does 30 damage plus 10 more damage for each Energy attached to Poliwrath but not used to pay for this attack's Energy cost. Extra Energy after the 2nd doesn't count.",
            damage: "30+",
            convertedEnergyCost: 3
          },
          {
      ...
      },
      {
        ...
        attacks: [
          ...
          },
          {
            ...
            name: "Hyper Beam",
            text:
              "If the Defending Pokémon has energy cards attached to it, choose 1 of them and discard it.",
            damage: "20",
            convertedEnergyCost: 4
          }
        ],
        ...
        attacks: [
          {
            ...
            name: "Hydro Pump",
            text:
              "Does 40 damage plus 10 more damage for each attached to Blastoise but not used to pay for this attack's Energy cost. Extra Energy after the 2nd doesn't count.",
            damage: "40+",
            convertedEnergyCost: 3
          }
        ],
      ...
      },
      {
        ...
        ability: {
          name: "Energy Burn",
          text:
            "As often as you like during your turn (before your attack), you may turn all Energy attached to Charizard into R for the rest of the turn. This power can't be used if Charizard is Asleep, Confused, or Paralyzed.",
          type: "Pokémon Power"
        },
        hp: "120",
        retreatCost: ["Colorless", "Colorless", "Colorless"],
